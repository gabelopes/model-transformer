...
:- use_module(panel, [get_panel_for_class/2, create_panel/2, create_panel/3, create_panel/4, create_panel/5, show_class_panel/1, hide_class_panel/1, remove_class_panel/1, set_class_panel_label/2, set_class_panel_position/2]).
:- use_module(field, [create_field/3, create_field/4, create_field/5, create_field/6, show_field/2, hide_field/2, remove_field/2, set_field_label/3, set_field_position/3]).
